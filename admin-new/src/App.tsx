...
function AdminDashboard({ logtoUser, onLogtoSignOut, getAccessToken }: { logtoUser: IdTokenClaims | null; onLogtoSignOut: () => void; getAccessToken: (resource?: string) => Promise<string> }) {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-300 font-sans overflow-hidden selection:bg-cyan-900 selection:text-cyan-50 relative flex flex-col">
      ...
      <header className="relative z-10 border-b border-cyan-900/50 bg-black/50 backdrop-blur-md px-3 py-1.5 flex justify-between items-center">
        <div className="flex items-center gap-3 lg:gap-5 min-w-0">
          <div className="flex items-center gap-2 text-cyan-400 shrink-0">
            <Hexagon className="w-4 h-4" />
            <span className="text-xs lg:text-sm font-bold tracking-widest hidden sm:inline">{GATEWAY_NAME}</span>
          </div>
          <div className="flex items-center gap-1.5 shrink-0">
            <div className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
            <span className="text-[10px] text-emerald-500 hidden sm:inline">ONLINE</span>
          </div>
          {/* ── Relay Selector ── */}
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            <select
              ...
              className="bg-black/60 border border-fuchsia-900/50 text-fuchsia-300 font-mono text-xs px-1.5 py-0.5 focus:outline-none focus:border-fuchsia-500 cursor-pointer min-w-0"
            >
              {relayNodes.map((n) => (
            ...
            <button type="button"
              ...
              className="min-h-[44px] min-w-[44px] px-2 py-1.5 border border-fuchsia-900/50 text-fuchsia-400 hover:text-fuchsia-300 hover:border-fuchsia-700 transition-all text-xs"
        ...
        <div className="text-xs flex items-center gap-2 shrink-0">
          <button type="button"
            ...
            className="min-h-[44px] min-w-[44px] px-2 py-1.5 border border-cyan-800 hover:bg-cyan-950/50 hover:text-cyan-400 transition-all flex items-center justify-center lg:gap-1.5"
          ...
          <button type="button" onClick={onLogtoSignOut}
            className="min-h-[44px] px-2 lg:px-3 py-1.5 border border-rose-900/50 text-rose-500 hover:text-rose-300 hover:border-rose-700 transition-all text-xs"
          >
            <span className="hidden sm:inline">Sign out</span>
            <LogOut className="w-3.5 h-3.5 sm:hidden" />
          </button>
          {logtoUser ? (
            <span className="text-cyan-400 text-xs items-center gap-1 hidden md:flex" title={logtoUser.sub}>
              <Users className="w-3 h-3" /><span className="truncate max-w-[80px]">{logtoUser.name ?? logtoUser.username ?? logtoUser.email ?? logtoUser.sub}</span>
            </span>
          ) : null}
        </div>
      </header>
          ...
          <div className="flex h-full flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center justify-between gap-2 lg:gap-4 flex-wrap">
              <div className="flex flex-col gap-0.5 min-w-0">
                <span className="text-sm lg:text-lg font-bold text-cyan-50">{GATEWAY_NAME}</span>
                <span className="font-mono text-xs text-cyan-500 truncate hidden sm:block">{gatewayEndpoint}</span>
              </div>

              <div className="flex items-center gap-3 lg:gap-6 shrink-0">
                <div className="flex flex-col items-end">
                  <span className="text-[10px] text-cyan-600 hidden sm:inline">CHANNELS</span>
                  <span className="font-mono text-lg lg:text-xl text-cyan-400">{relayState?.channels.length ?? 0}</span>
                </div>
                <div className="flex flex-col items-end">
                  <span className="text-[10px] text-cyan-600 hidden sm:inline">BACKENDS</span>
                  <span className="font-mono text-lg lg:text-xl text-cyan-400">{relayState?.stats.backendCount ?? 0}</span>
                </div>
                <div className="flex flex-col items-end">
                  <span className="text-[10px] text-cyan-600 hidden sm:inline">CLIENTS</span>
                  <span className="font-mono text-lg lg:text-xl text-cyan-400">{relayState?.stats.clientCount ?? 0}</span>
                </div>
                <div className="flex flex-col items-end">
                  <span className="text-[10px] text-cyan-600 hidden sm:inline">STATUS</span>
        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-3 min-h-0">
          <Panel title="Channels" icon={Network} className="w-full lg:w-[280px] xl:w-[320px] flex flex-col shrink-0">
                  ...
                  >
                    ...
                    <div className="flex flex-wrap justify-end gap-1 mt-1">
                      <button
                        ...
                        className="min-h-[44px] min-w-[44px] px-2 py-1.5 bg-black/30 border border-cyan-900/50 text-xs text-cyan-400 hover:text-cyan-100 hover:bg-cyan-950/50 transition-colors flex items-center justify-center gap-1"
                        title="Edit"
                      >
                      ...
                      <button
                        ...
                        className="min-h-[44px] min-w-[44px] px-2 py-1.5 bg-cyan-950/50 border border-cyan-800 text-xs text-cyan-400 hover:bg-cyan-900 hover:text-cyan-100 transition-colors flex items-center justify-center gap-1"
                        title="Config"
                      >
                        <Settings className="w-3.5 h-3.5" />
                      ...
                      <button
                        ...
                        className="min-h-[44px] min-w-[44px] px-2 py-1.5 bg-rose-950/30 border border-rose-900/50 text-xs text-rose-400 hover:bg-rose-900/50 hover:text-rose-100 transition-colors flex items-center justify-center gap-1"
                        title="Delete"
                      >
            ...
            <button
              ...
              className="mt-3 w-full py-2 border border-dashed border-cyan-800 text-cyan-600 text-xs hover:bg-cyan-950/30 hover:text-cyan-400 hover:border-cyan-500 transition-all flex items-center justify-center gap-2"
            >
                        ...
                        <td className="py-2 pr-2 text-right">
                          <div className="inline-flex flex-wrap justify-end gap-1">
                            <button
                              ...
                              className="min-h-[44px] min-w-[44px] inline-flex items-center justify-center gap-1 px-2 py-1.5 bg-fuchsia-950/30 border border-fuchsia-900/50 text-xs text-fuchsia-400 hover:bg-fuchsia-900/50 hover:text-fuchsia-100 transition-colors"
                              title="Connect"
                            >
                            ...
                            <button
                              ...
                              className="min-h-[44px] min-w-[44px] inline-flex items-center justify-center gap-1 px-2 py-1.5 bg-black/30 border border-cyan-900/50 text-xs text-cyan-400 hover:text-cyan-100 hover:bg-cyan-950/50 transition-colors"
                              title="Edit"
                            >
                              <Pencil className="w-3.5 h-3.5" />
                              <span className="hidden sm:inline">Edit</span>
                            ...
                            <button
                              ...
                              className="min-h-[44px] min-w-[44px] inline-flex items-center justify-center gap-1 px-2 py-1.5 bg-rose-950/30 border border-rose-900/50 text-xs text-rose-400 hover:bg-rose-900/50 hover:text-rose-100 transition-colors"
                              title="Delete"
                            >
                              <Trash2 className="w-3.5 h-3.5" />
                              <span className="hidden sm:inline">Delete</span>
